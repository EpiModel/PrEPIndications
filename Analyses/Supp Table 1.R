...
# Vectors ---------------------
# Column 1 - PrEP-eligible denominator (HIV-negative)
num <- length(which(artnet2$prep_hiv == 1))
numwhite <- length(which(artnet2$race.cat == "white" & artnet2$prep_hiv == 1))
numblack <- length(which(artnet2$race.cat == "black" & artnet2$prep_hiv == 1))
numhisp <- length(which(artnet2$race.cat == "hispanic" & artnet2$prep_hiv == 1))
numother <- length(which(artnet2$race.cat == "other" & artnet2$prep_hiv == 1))
numne <- length(which(artnet2$region == "Northeast" & artnet2$prep_hiv == 1))
nummw <- length(which(artnet2$region == "Midwest" & artnet2$prep_hiv == 1))
numsouth <- length(which(artnet2$region == "South" & artnet2$prep_hiv == 1))
numwest <- length(which(artnet2$region == "West" & artnet2$prep_hiv == 1))
num1517 <- length(which(artnet2$age.cat == "15-17" & artnet2$prep_hiv == 1))
num1824 <- length(which(artnet2$age.cat == "18-24" & artnet2$prep_hiv == 1))
num2534 <- length(which(artnet2$age.cat == "25-34" & artnet2$prep_hiv == 1))
num3544 <- length(which(artnet2$age.cat == "35-44" & artnet2$prep_hiv == 1))
num4554 <- length(which(artnet2$age.cat == "45-54" & artnet2$prep_hiv == 1))
num5565 <- length(which(artnet2$age.cat == "55-65" & artnet2$prep_hiv == 1))

# Column 2
# Meet 4 base USPHS Indications (leaving out adult-only affects 15-17 year olds)
numbase <- length(which(artnet2$prep_hiv == 1 &
                          artnet2$prep_part6mo == 1 &
                          artnet2$prep_nonmonog == 1))
numwhitebase <- length(which(artnet2$race.cat == "white"  &
                               artnet2$prep_hiv == 1 &
                               artnet2$prep_part6mo == 1 &
                               artnet2$prep_nonmonog == 1))
numblackbase <- length(which(artnet2$race.cat == "black"  &
                               artnet2$prep_hiv == 1 &
                               artnet2$prep_part6mo == 1 &
                               artnet2$prep_nonmonog == 1))
numhispbase <- length(which(artnet2$race.cat == "hispanic"  &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
numotherbase <- length(which(artnet2$race.cat == "other"  &
                               artnet2$prep_hiv == 1 &
                               artnet2$prep_part6mo == 1 &
                               artnet2$prep_nonmonog == 1))
numnebase <- length(which(artnet2$region == "Northeast"  &
                            artnet2$prep_hiv == 1 &
                            artnet2$prep_part6mo == 1 &
                            artnet2$prep_nonmonog == 1))
nummwbase <- length(which(artnet2$region == "Midwest" &
                            artnet2$prep_hiv == 1 &
                            artnet2$prep_part6mo == 1 &
                            artnet2$prep_nonmonog == 1))
numsouthbase <- length(which(artnet2$region == "South" &
                               artnet2$prep_hiv == 1 &
                               artnet2$prep_part6mo == 1 &
                               artnet2$prep_nonmonog == 1))
numwestbase <- length(which(artnet2$region == "West"  &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num1517base <- length(which(artnet2$age.cat == "15-17" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num1824base <- length(which(artnet2$age.cat == "18-24" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num2534base <- length(which(artnet2$age.cat == "25-34" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num3544base <- length(which(artnet2$age.cat == "35-44" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num4554base <- length(which(artnet2$age.cat == "45-54" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
num5565base <- length(which(artnet2$age.cat == "55-65" &
                              artnet2$prep_hiv == 1 &
                              artnet2$prep_part6mo == 1 &
                              artnet2$prep_nonmonog == 1))
...
numwhitebasecai <- length(which(artnet2$race.cat == "white" &
                                  artnet2$prepind_uai == 1))
numblackbasecai <- length(which(artnet2$race.cat == "black" &
                                  artnet2$prepind_uai == 1))
numhispbasecai <- length(which(artnet2$race.cat == "hispanic" &
                                 artnet2$prepind_uai == 1))
numotherbasecai <- length(which(artnet2$race.cat == "other" &
                                  artnet2$prepind_uai == 1))
numnebasecai <- length(which(artnet2$region == "Northeast" &
                               artnet2$prepind_uai == 1))
nummwbasecai <- length(which(artnet2$region == "Midwest" &
                               artnet2$prepind_uai == 1))
numsouthbasecai <- length(which(artnet2$region == "South" &
                                  artnet2$prepind_uai == 1))
numwestbasecai <- length(which(artnet2$region == "West" &
                                 artnet2$prepind_uai == 1))
num1517basecai <- length(which(artnet2$age.cat == "15-17" &
                                 artnet2$prepind_uai == 1))
num1824basecai <- length(which(artnet2$age.cat == "18-24" &
                                 artnet2$prepind_uai == 1))
num2534basecai <- length(which(artnet2$age.cat == "25-34" &
                                 artnet2$prepind_uai == 1))
num3544basecai <- length(which(artnet2$age.cat == "35-44" &
                                 artnet2$prepind_uai == 1))
num4554basecai <- length(which(artnet2$age.cat == "45-54" &
                                 artnet2$prepind_uai == 1))
num5565basecai <- length(which(artnet2$age.cat == "55-65" &
                                 artnet2$prepind_uai == 1))

# Column 4 - Base + STI
numbasesti <- length(which(artnet2$prepind_sti == 1))
numwhitebasesti <- length(which(artnet2$race.cat == "white" &
                                  artnet2$prepind_sti == 1))
numblackbasesti <- length(which(artnet2$race.cat == "black" &
                                  artnet2$prepind_sti == 1))
numhispbasesti <- length(which(artnet2$race.cat == "hispanic" &
                                 artnet2$prepind_sti == 1))
numotherbasesti <- length(which(artnet2$race.cat == "other" &
                                  artnet2$prepind_sti == 1))
numnebasesti <- length(which(artnet2$region == "Northeast" &
                               artnet2$prepind_sti == 1))
nummwbasesti <- length(which(artnet2$region == "Midwest" &
                               artnet2$prepind_sti == 1))
numsouthbasesti <- length(which(artnet2$region == "South" &
                                  artnet2$prepind_sti == 1))
numwestbasesti <- length(which(artnet2$region == "West" &
                                 artnet2$prepind_sti == 1))
num1517basesti <- length(which(artnet2$age.cat == "15-17" &
                                 artnet2$prepind_sti == 1))
num1824basesti <- length(which(artnet2$age.cat == "18-24" &
                                 artnet2$prepind_sti == 1))
num2534basesti <- length(which(artnet2$age.cat == "25-34" &
                                 artnet2$prepind_sti == 1))
num3544basesti <- length(which(artnet2$age.cat == "35-44" &
                                 artnet2$prepind_sti == 1))
num4554basesti <- length(which(artnet2$age.cat == "45-54" &
                                 artnet2$prepind_sti == 1))
num5565basesti <- length(which(artnet2$age.cat == "55-65" &
                                 artnet2$prepind_sti == 1))

# Columns 5 and 6
# PrEP-eligible / PrEP denominator and PrEP-eligible / Overall denominator
numprepany <- length(which(artnet2$prepind_any == 1))
numwhiteprepany <- length(which(artnet2$race.cat == "white" &
                                  artnet2$prepind_any == 1))
numblackprepany <- length(which(artnet2$race.cat == "black" &
                                  artnet2$prepind_any == 1))
numhispprepany <- length(which(artnet2$race.cat == "hispanic" &
                                 artnet2$prepind_any == 1))
numotherprepany <- length(which(artnet2$race.cat == "other" &
                                  artnet2$prepind_any == 1))
numneprepany <- length(which(artnet2$region == "Northeast" &
                               artnet2$prepind_any == 1))
nummwprepany <- length(which(artnet2$region == "Midwest" &
                               artnet2$prepind_any == 1))
numsouthprepany <- length(which(artnet2$region == "South" &
                                  artnet2$prepind_any == 1))
numwestprepany <- length(which(artnet2$region == "West" &
                                 artnet2$prepind_any == 1))
num1517prepany <- length(which(artnet2$age.cat == "15-17" &
                                 artnet2$prepind_any == 1))
num1824prepany <- length(which(artnet2$age.cat == "18-24" &
                                 artnet2$prepind_any == 1))
num2534prepany <- length(which(artnet2$age.cat == "25-34" &
                                 artnet2$prepind_any == 1))
num3544prepany <- length(which(artnet2$age.cat == "35-44" &
                                 artnet2$prepind_any == 1))
num4554prepany <- length(which(artnet2$age.cat == "45-54" &
                                 artnet2$prepind_any == 1))
num5565prepany <- length(which(artnet2$age.cat == "55-65" &
                                 artnet2$prepind_any == 1))
...
STable1 <- cbind(negdenom, basemen, commoncai, commonsti, commonany,
                commonoveralldenom)
colnames(STable1) <- c("Negative Denominator", "Base Indications", "Base + CAI",
                      "Base + STI", "% of PrEP Denom Indicated for PrEP",
                      "% of Overall Denom Indicated for PrEP")
rownames(STable1) <- c("All", "White", "Black", "Hisp", "Other",
                      "Northeast", "Midwest", "South", "West",
                      "15-17", "18-24", "25-34", "35-44", "45-54", "55-65")
View(STable1)

# Output Table -----------------------------------------------------------------
write.csv(STable1, file = "Output/Supp Table 1.csv")
