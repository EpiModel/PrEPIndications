...
STable2 <- cbind(negdenom, basemen, commoncai, commonsti, commonany,
                commonoveralldenom)
colnames(STable2) <- c("Negative Denominator", "Base Indications", "Base + CAI",
                      "Base + STI", "% of PrEP Denom Indicated for PrEP",
                      "% of Overall Denom Indicated for PrEP")
rownames(STable2) <- c("All", "White", "Black", "Hisp", "Other",
                      "Northeast", "Midwest", "South", "West",
                      "15-17", "18-24", "25-34", "35-44", "45-54", "55-65")
View(STable2)

# Output Table -----------------------------------------------------------------
write.csv(STable2, file = "Output/Supp Table 2.csv")
